...
public class TypeTemplateController {
     ...
     * @return
     */
    @RequestMapping(value="/type/spec/{id}")
    public List<Map> getSpecOptionByTypeId(@PathVariable(value = "id")long id){
        //到Service查询封装好的List<Map>
        return  typeTemplateService.getSpecOptionByTypeId(id);
    }
