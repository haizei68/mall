                ...
                <div class="zoom">
						<#if (imageList?size>0)>
                            ...
                            <div id="preview" class="spec-preview">
							    <span class="jqzoom">
								    <img jqimg="${imageList[0].url}" width="400" height="400"
                                         src="${imageList[0].url}"/>
							    </span>
                            </div>
                        ...
                        <#list specificationList as spec>
                            ...
                            <dl>
                                ...
                                <#list spec.attributeValue as specValue>
                                    <dd>
                                        <a href="javascript:;"
                                           ng-click="selectSpec('${spec.attributeName}','${specValue}')"
                                           class="{{selectSpecInfo('${spec.attributeName}','${specValue}')==true?'selected':''}}">${specValue}
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;"  ng-click="addCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
									<#list customAttribute as customerAttr>
                                        <li>${customerAttr.text}:${customerAttr.value}</li>
                                    </#list>
                            </ul>
